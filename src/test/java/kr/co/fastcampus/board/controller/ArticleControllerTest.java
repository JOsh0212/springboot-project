...
//                .andExpect(model().attributeExists("paginationBarNumbers"))
    ...
    public void givenNothing_whenRequestingArticleView_thenReturnsArticleView() throws Exception {
        ...
        Long articleId = 1L;
        long totalCount = 1L;
        given(articleService.getArticleWithCommnets(articleId)).willReturn(createArticleWithCommentsDTO());
    ...
    @Test
    @WithUserDetails(value = "unoTest",userDetailsServiceBeanName = "userDetailsService",setupBefore = TestExecutionEvent.TEST_EXECUTION)   //userDetailsServiceBeanName는 하나만 만들면 안해도 됨
    ...
    void givenUpdatedArticleInfo_whenRequesting_thenUpdatesNewArticle() throws Exception {
        ...
        mvc.perform(
                        post("/articles/" + articleId + "/form")
                                ...
                                .content(formDataEncoder.encode(articleRequest))
                                .with(csrf())
//                                .with(user(BoardPrinciple.of("uno","pw","uno@email.com","UNO","uno test")))   //이렇게 넣을 수도 있음
                )
                .andExpect(status().is3xxRedirection())
